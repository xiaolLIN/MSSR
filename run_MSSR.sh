...
python run_model.py --gpu_id=1 --model=MSSR --dataset="Amazon_Toys_and_Games" \
           --ssl=1 --cl='idropwc' --tau=1 --cllmd=0.08 --sim='dot' \
           --n_layers=3 --n_heads=4  \
           --aaplmd=3 --attribute_predictor='linear' --aap='wi_wc_bce' --aap_gate=1 \
           --ip_mode='gating' \
...
python run_model.py --gpu_id=1 --model=MSSR --dataset="Amazon_Beauty" \
           --ssl=1 --cl='idropwc' --tau=1 --cllmd=0.14 --sim='dot' \
           --n_layers=3 --n_heads=2  \
           --aaplmd=4 --attribute_predictor='linear' --aap='wi_wc_bce' --aap_gate=1 \
           --ip_mode='gating' \
...
python run_model.py --gpu_id=1 --model=MSSR --dataset="Amazon_Sports_and_Outdoors"  \
           ...
           --aaplmd=2 --attribute_predictor='linear' --aap='wi_wc_bce' --aap_gate=1 \
           --ip_mode='gating'  \
