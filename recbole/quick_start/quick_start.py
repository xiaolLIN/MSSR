...
def run_recbole(model=None, dataset=None, config_file_list=None, config_dict=None, saved=True):
    ...
    return {
        'model': trainer.saved_model_file,
...
def load_checkpoint(model, resume_file, device):
    ...
    message_output = 'Loading model structure and parameters from {}'.format(resume_file)
    print(message_output)

    return model, best_valid_score
