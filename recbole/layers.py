...
class ContextSeqEmbAbstractLayer(nn.Module):
        ...
        for type in self.types:
            for field_name in self.field_names[type]:
                if self.dataset.field2type[field_name] == FeatureType.TOKEN:
                    ...
                    # print('==================== \n layers.py: field name:', field_name)   # 'categories'
                    self.token_seq_field_names[type].append(field_name)
                    # print('==================== \n layers.py: dataset.num(field_name):', self.dataset.num(field_name))   # 类别数
    ...
    def embed_input_fields(self, user_idx, item_idx, period, select_cate):
    ...
    def forward(self, user_idx, item_idx, period=None, select_cate=None):
        return self.embed_input_fields(user_idx, item_idx, period, select_cate)
